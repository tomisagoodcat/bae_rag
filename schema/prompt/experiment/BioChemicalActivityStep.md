...
- **Soil sample preparation**  
  - Action: air-drying, sieving (20-mesh).  
  - used: soil specimen, sieve.  
  - generated: prepared soil.  

- **DOC concentration measurement**  
  - Action: porewater DOC quantified via TOC analyzer.  
  - used: filtered porewater, TOC analyzer.  
  - generated: DataSet (DOC, mg/L).  
  - environment: NOM-Lab (SWU).  
